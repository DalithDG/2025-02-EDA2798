...
public class Loans {
    ...
    public Loans(LocalDate date, String type, BigDecimal totalLoan, BigDecimal amountPaid, BigDecimal outstandingAmt, TypeLoans typeLoans) {
        this.date = date;
        this.type = type;
        this.totalLoan = totalLoan;
        this.amountPaid = amountPaid;
        this.outstandingAmt = outstandingAmt;
        this.typeLoans = typeLoans;
    }
    ...
    public TypeLoans getTypeLoans() {
        return typeLoans;
    }

    public void setTypeLoans(TypeLoans typeLoans) {
        this.typeLoans = typeLoans;
    }
